...
public class ArgumentParser {
  ...
  public void parse(String[] args) {
    ...
    for (int i = 0; i < args.length; i++) {
      ...
      private void checkIfTooFewArguments(String[] args, String key_string){if(args.length<argumentNames.size()){
      ...
      private void checkIfTooManyArguments(String[] args, String key_string){ if(args.length>argumentNames.size()){
